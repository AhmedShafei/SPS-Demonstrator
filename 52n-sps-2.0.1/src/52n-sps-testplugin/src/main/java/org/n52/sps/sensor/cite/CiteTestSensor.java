...
public class CiteTestSensor extends SensorPlugin {
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(CiteTestSensor.class);

	private CiteTaskScheduler scheduler;

	public CiteTestSensor(SensorTaskService sensorTaskService,
	...
	private void scheduleAndAcceptTask(SubmitTaskingRequest submit,
		...
		try {
			...
			CiteTaskSimulation simulation = CiteTaskSimulation
					.createTaskSimulation(submitTask, validInputs);
	...
	private CiteTaskResultAccess createResultAccessGenerator(
			SensorTask sensorTask) {
		return new CiteTaskResultAccess(sensorTask,
