...
public class AdminOperator extends SpsOperator implements SpsAdmin {
	...
	public void setInsertSensorOfferingListeners(
			List<InsertSensorOfferingListener> insertSensorOfferingListeners) {
		this.insertSensorOfferingListeners = insertSensorOfferingListeners;
	}

	public void setDeleteSensorOfferingListeners(
			List<DeleteSensorOfferingListener> deleteSensorOfferingListeners) {
	...
	public String insertSensorOffering(
			InsertSensorOfferingDocument insertSensorOfferingDocument,
			OwsExceptionReport exceptionReport) throws InternalServiceException {
		LOGGER.debug("insertSensorOffering: {}",
				insertSensorOfferingDocument.xmlText());

		InsertSensorOfferingEvent insertSensorOfferingEvent = new InsertSensorOfferingEvent(
				insertSensorOfferingDocument);

		// TODO extract information, inform listeners

		fireRegisterSensorOfferingEvent(insertSensorOfferingEvent);

		// Return Sensor Procedure
		String procedure = insertSensorOfferingDocument
				.getInsertSensorOffering().getSensorInstanceData()
				.getProcedure().getStringValue();
		return procedure;
	}

	private void fireRegisterSensorOfferingEvent(
			InsertSensorOfferingEvent insertSensorOfferingEvent)
	...
	public void deleteSensorOffering(XmlObject request,
			OwsExceptionReport exceptionReport) throws InternalServiceException {
	...
	private void fireDeleteSensorOfferingEvent(
			DeleteSensorOfferingEvent deleteSensorOfferingEvent)
			throws InternalServiceException {
	...
	private void addRegisterSensorOperation(
			OperationsMetadata operationsMetadata) {
		Operation registerSensorOperation = operationsMetadata
				.addNewOperation();
		registerSensorOperation.setName(INSERT_SENSOR_OFFERING);
		addDcpExtensionBinding(registerSensorOperation, httpBinding,
				INSERT_RESOURCE);
	}
	...
	private void addDeleteSensorOperation(OperationsMetadata operationsMetadata) {
		...
		addDcpExtensionBinding(deleteSensorOperation, httpBinding,
				DELETE_RESOURCE);
	}
	...
	/**
	 * @param interceptCapabilities
	 *            if this administrator shall intercept operations to
