...
public class SPSXmlValidationDelegate implements DelegationHandler {

	private SPSXmlDelegate requestHandler;
	private SensorPlanningService service;

	public SPSXmlValidationDelegate(SPSXmlDelegate toDecorate) {
