...
public class WamTestSensorTest extends TestCase {
	...
	private static final String PLUGIN_TYPE = "org.n52.sps.sensor.wam.WamTestSensor";

	private WamTestSensor sensor;
	...
	protected void setUp() throws Exception {
		...
		sensor = new WamTestSensor(new SensorTaskService(
