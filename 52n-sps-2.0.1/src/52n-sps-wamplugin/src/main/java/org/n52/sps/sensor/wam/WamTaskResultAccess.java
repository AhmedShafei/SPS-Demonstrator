...
public class WamTaskResultAccess implements ResultAccessAvailabilityDescriptor {

    private ResultAccessDataServiceReference resultAccessDataServiceReference;

    private SensorTask sensorTask;

    public WamTaskResultAccess(SensorTask sensorTask, ResultAccessDataServiceReference dataReference) {
    ...
    /**
     * The {@link WamTaskResultAccess} applies the service reference template provided when sensor instance
